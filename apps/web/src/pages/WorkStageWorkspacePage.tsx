                ...
                {stages.map((stage) => (
                  ...
                  >
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <span className="shrink-0 rounded-full bg-slate-100 px-2.5 py-1 text-[11px] font-bold text-slate-700">{t(`work.stageStatus.${stage.status}`, { defaultValue: formatStatus(stage.status) })}</span>
                    </div>
              ...
              <div className="space-y-6">
                ...
                <dl className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                  <div className="rounded-2xl bg-slate-50 p-3">
                    <dt className="text-xs font-semibold text-slate-500">{t("work.stageWorkspace.assignmentMode")}</dt>
                    <dd className="mt-1 text-sm font-bold text-slate-900">{formatStatus(selectedStage.assignmentMode)}</dd>
                  </div>
                  <div className="rounded-2xl bg-slate-50 p-3">
                    <dt className="text-xs font-semibold text-slate-500">{t("work.stageWorkspace.approval")}</dt>
                    <dd className="mt-1 text-sm font-bold text-slate-900">{formatStatus(selectedStage.approvalMode)}</dd>
                  </div>
                  <div className="rounded-2xl bg-slate-50 p-3">
                    <dt className="text-xs font-semibold text-slate-500">{t("work.stageWorkspace.stageVersion")}</dt>
